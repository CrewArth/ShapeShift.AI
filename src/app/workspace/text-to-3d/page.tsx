...
import { Info, CheckCircle2, LoaderCircle } from 'lucide-react'
            ...
            <div className="tips-container">
              ...
              <div className="tips-list">
                <div className="tip-item">
                  ...
                  <span>Use high-quality prompts with specific details about shape, material, and style</span>
                </div>
                <div className="tip-item">
                  <CheckCircle2 size={16} className="tip-icon" />
                  <span>Include negative prompts to avoid unwanted features in your model</span>
                </div>
                <div className="tip-item">
                  <CheckCircle2 size={16} className="tip-icon" />
                  <span>Keep your prompt focused on a single object for optimal results</span>
                </div>
              </div>
            </div>
          </div>
